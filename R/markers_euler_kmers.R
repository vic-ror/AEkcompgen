#' Creates an Euler Diagram based on the kmer sequence distribuition among markers.
...
#'
#' @return An Euler Diagram based on the kmer distribuition among markers
#' @export
...
#' venn_k <- markers_euler_kmers(data_1, data_2)
#' # 3. View result
#' print(venn_k)
markers_euler_kmers <- function(..., path_db = NULL, marker_label = NULL, color_pallete = "PuBuGn"){
  #Load List
  ...
  euler_cd <- plot(euler_list,
                   ...
                   main = "Kmer distribution across markers")
