...
#' venn_k <- dataset_upset_kmers(data_1, data_2)
#' # 3. View result
#' print(venn_k)
dataset_upset_kmers <- function(..., path_db = NULL, dataset_label = NULL, color_pallete = "PuBuGn", empty_intersection = NULL, file_name = NULL){
  #Load List
  ...
  upset_plot <- UpSetR::upset(data = upset_list,
                              ...
                              sets.x.label = "Kmers per dataset",
