...
First, in order to turn the sequencing .fastq into fairly comparable datasets read processing is required. This part was designed to work with Illumnina short reads.
