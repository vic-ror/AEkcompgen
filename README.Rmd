...
```{r}
#1.Run k-mer counter
dataset_1 <- run_jellyfish(fasta_file = "dataset_1.fasta",
                           length = 45,
                           marker = "dataset1",
                           out = "dataset_1_jf")
...
#2. Visualization of the k-mer counting data
 #Run jellyfish histo
    ...
    marked_dataset_1_histo <- mark_jellyfish_histo(histo_df = dataset_1_histo,
                                                   marker = "Dataset1")
    marked_dataset_2_histo <- mark_jellyfish_histo(histo_df = dataset_2_histo,
                                                   marker = "Dataset2")
...
#4. Get exclusive and shared k-mers
    exclusive_kmers <- select_exclusive_seq(dataset_1, dataset_2_histo)
...
cluster_1_seq_df <- get_clusters_1_seq(clustered_datasets,
                   path_db = NULL)
